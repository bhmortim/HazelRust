# Contributing to hazelcast-client
...
# Run tests (requires a Hazelcast cluster on localhost:5701)
cargo test
...
Integration tests go in `tests/` and require a running Hazelcast cluster:
