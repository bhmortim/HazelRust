...
async fn test_cluster_connectivity() {
    ...
    map.put("test-key".to_string(), "test-value".to_string())
        .await
        .unwrap();
...
async fn test_multiple_clients() {
    ...
    map1.put("key1".to_string(), "from-client1".to_string())
        .await
        .unwrap();
    ...
    map2.put("key2".to_string(), "from-client2".to_string())
        .await
        .unwrap();
...
async fn test_data_structure_isolation() {
    ...
    map1.put("shared-key".to_string(), "map1-value".to_string())
        .await
        .unwrap();
    map2.put("shared-key".to_string(), "map2-value".to_string())
        .await
        .unwrap();
...
async fn test_serialization_types() {
    ...
    assert_eq!(
        i32_map.get(&"key".to_string()).await.unwrap(),
        Some(i32::MAX)
    );
    ...
    assert_eq!(
        i64_map.get(&"key".to_string()).await.unwrap(),
        Some(i64::MAX)
    );
    ...
    f32_map
        .put("key".to_string(), std::f32::consts::PI)
        .await
        .unwrap();
    ...
    f64_map
        .put("key".to_string(), std::f64::consts::E)
        .await
        .unwrap();
    ...
    assert_eq!(
        bool_map.get(&"false".to_string()).await.unwrap(),
        Some(false)
    );
