...
The four technically-completable client items from the session handoff notes, each fixed, verified live against EE 5.7, and pushed to `main`. (This does **not** change the overall CBDC verdict, which remains NO-GO pending the external P3 items.)
